        ...
        parseFormat: function (vChar, vDate) {
            ...
            fmt = {
                ...
                B: function () {
                    ...
                    return _lpad(
                        Math.floor((H + i + s + HOUR) / 86.4) % 1000,
                        3
                    );
                },
                /**
    ...
    $.fn.datetimepicker = function (opt, opt2) {
        ...
        createDateTimePicker = function (input) {
                    ...
                    $.each(
                        ...
                        function (index, value) {
                            ...
                            if ($.isArray(value)) {
                                ...
                                var splitData = $.map(value.split(","), $.trim);
                                dateTest = dateHelper.parseDate(
                                    splitData[0],
                                    options.formatDate
                                );
                                dateEnd = dateHelper.parseDate(
                                    splitData[1],
                                    options.formatDate
                                );
                                desc = splitData[2];
                    ...
                    input.off("blur.xdsoft").on("blur.xdsoft", function () {
                        if (
                            ...
                            if (d) {
                                ...
                                $(this).val(
                                    dateHelper.formatDate(d, options.format)
                                );
                            } else {
                                var splittedHours = +[
                                        $(this).val()[0],
            ...
            XDSoft_datetime = function () {
                ...
                _this.getWeekOfYear = function (datetime) {
                    if (
                        ...
                        var week = options.onGetWeekOfYear.call(
                            datetimepicker,
                            datetime
                        );
                ...
                _this.strToDateTime = function (sDateTime) {
                    ...
                    if (tmpDate) {
                        tmpDate[2] = dateHelper.parseDate(
                            tmpDate[2],
                            options.formatDate
                        );
                    }
                ...
                .on("touchend mousedown.xdsoft", function () {
                    ...
                    (function arguments_callee4(v) {
                        ...
                        timeboxparent.trigger(
                            ...
                            [
                                Math.abs(
                                    parseInt(timebox[0].style.marginTop, 10) /
                                        (height - pheight)
                                ),
                            ]
                        );
            ...
            setPos = function () {
                ...
                verticalPosition =
                    dateInputOffset.top + dateInputElem.offsetHeight - 1;
                ...
                if (
                    ...
                    var diff =
                        datepicker.parent().outerWidth(true) -
                        dateInputElem.offsetWidth;
                    left = left - diff;
                }

                if ($dateInput.parent().css("direction") === "rtl") {
                    left -=
                        datetimepicker.outerWidth() - $dateInput.outerWidth();
                }
                ...
                if (options.fixed) {
                    ...
                    if (dateInputHasFixedAncestor) {
                        ...
                        if (
                            verticalPosition + dateInputElem.offsetHeight >
                            windowHeight + windowScrollTop
                        ) {
                            verticalPosition =
                                dateInputOffset.top -
                ...
                forEachAncestorOf(datetimepickerElem, function (ancestorNode) {
                    ...
                    if (
                        ...
                        left =
                            left - (windowWidth - ancestorNode.offsetWidth) / 2;
                        return false;
                    }
                });
                ...
                if ($.type(options.mask) === "string") {
                    ...
                    input.on("keydown.xdsoft", function (event) {
                        ...
                        if (
                            ...
                            if (
                                ([AKEY, CKEY, VKEY, ZKEY, YKEY].indexOf(key) !==
                                    -1 &&
                                    ctrlDown) ||
                                [
                                    ESC,
